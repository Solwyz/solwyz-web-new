    ...
    >
      <div className="relative">
        ...
        <button
          ...
          className="absolute top-2 right-2 w-8 h-8 hover:rounded-full hover:bg-[#F7D4C5A1] z-10"
        >
          <img src='/assets/x.svg' alt="Close" className="mx-auto w-6 h-6" />
        </button>
        ...
        <div className="absolute inset-0 mt-10 p-4 flex flex-col justify-between">
          ...
          <div className="flex justify-center items-center">
            ...
            >
              <img src='/assets/wpIcn.svg' alt="WhatsApp" className="w-4 h-4" />
              Book a demo
            </button>
          </div>
        </div>
