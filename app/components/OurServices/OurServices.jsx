...
// import Img2 from "@assets/OurServices/socialmark.svg";
...
// import Img9 from "@assets/OurServices/ero.svg";
...
export default function OurServices() {
  ...
  useEffect(() => {
    ...
    gsap.fromTo(
      ".parallax-heading",
      { opacity: 0, yPercent: 30, scale: 1.2, filter: "blur(10px)" },
      {
        opacity: 0.07,
        yPercent: -10,
        scale: 1,
  ...
  const imgList = [
  "/assets/OurServices/seo.svg",
  "/assets/OurServices/socialmm.svg",
  "/assets/OurServices/sem.svg",
  "/assets/OurServices/influ.svg",
  "/assets/OurServices/videomarketing.svg",
  "/assets/OurServices/branding.svg",
];
const imgList2 = [
  "/assets/OurServices/webdeve.svg",
  "/assets/OurServices/appmark.svg",
  "/assets/OurServices/erp.svg",
  "/assets/OurServices/crm.svg",
];
  const titles = [
    "SEO Services",
  ...
  const titles2 = ["Web Development", "App Development", "ERP Solutions", "CRM Solutions"];
  const descriptions = [
  ...
  return (
    <div
      className="relative mt-[184px] md:max-w-[1440px] md:mx-auto md:px-6 px-6 md:mt-[72px]"
      ref={cardsRef}
    >
      ...
      <div className="relative z-10 our-service">
        <div className="md:px-[120px] md:mt-0 mt-[72px]">
          <h1
            ref={headingRef}
            className="md:text-[48px] text-[24px] font-bold md:text-center text-center text-[#FFFFFF] content"
          >
            Our Services
          </h1>
        </div>
        ...
        <div>
          <div className="relative flex justify-center mt-4 vertical-line-container">
            <img
              ref={lineRef}
              src='/assets/OurServices/verticleline.svg'
              alt="vertical line"
          ...
          {/* Digital Marketing */}
          <div>
            <div className="text-[32px] font-bold text-white text-center md:mt-14">
              Digital Marketing
            </div>
            <img className="mx-auto mt-4" src='/assets/OurServices/horizondalline.svg' alt="Horizontal Line" />
          </div>

          <div className="md:flex flex-col items-center md:mt-16 mt-8 space-y-10">
            <div className="flex gap-8 justify-center flex-wrap">
              {[0, 1, 2, 3].map((index) => (
                <Link key={index} href={`/services/${links[index]}`}
                className="group relative md:w-[282px] w-full">
                    ...
                    <div className="relative bg-black border h-[338px] border-[#676767] rounded-tr-3xl rounded-bl-3xl p-6 w-full z-10">
                      <div className="pb-[24px]">
                        ...
                        <p className="text-sm font-medium leading-[18px] mt-3 text-[#A5A5A5] text-justify">
                          {descriptions[index]}
                        </p>
                      </div>
                    </div>
          ...
          <div className="mt-8 md:mt-16 space-y-10">
            <div className="flex-col items-center space-y-10 md:flex md:flex-wrap md:flex-row md:justify-center md:gap-8 md:space-y-0">
              {[0, 1, 2, 3].map((index) => (
                <Link key={index} href={`/services/${links2[index]}`}
                className="group relative w-full md:w-[282px]">
