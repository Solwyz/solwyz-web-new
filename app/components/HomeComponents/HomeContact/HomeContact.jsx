"use client"; // ✅ Needed because we’re using useState, event handlers, and API calls
    ...
    <div className="bg-white md:px-[120px] md:py-[104px] px-4 py-12">
      <div className="md:flex md:justify-between">
        <div className="md:mt-[64px]">
          <h1 className="font-bold text-[40px] text-black leading-10 text-start md:w-[350px]">
            Get In Touch With Our{" "}
            <span className="text-[#04A391] font-normal">Support</span>
          </h1>
          <p className="font-normal text-base leading-6 mt-6 text-black">
          ...
          <div className="flex items-center space-x-2 mt-6">
            ...
            >
              <img
                src='/assets/homeContacts/linkedin.svg'
            ...
            >
              <img
                src='/assets/homeContacts/fbIcon.svg'
                className="hover:bg-[#D5F7F3] rounded-full w-[30px] h-[30px] cursor-pointer"
                alt="Facebook"
              />
            </a>
            ...
            >
              <img
                src="/assets/homeContacts/insta.svg "
                className="hover:bg-[#D5F7F3] rounded-full w-[30px] h-[30px] cursor-pointer"
                alt="Instagram"
              />
            </a>
        ...
        <div className="w-full md:w-[675px] py-10 px-4 mt-6 md:mt-0 md:px-10 border border-[#DBDBDB]">
          <form className="space-y-10 text-black" onSubmit={handleSubmit}>
            {/* Name and Email */}
            ...
            <div className="flex flex-col md:flex-row gap-6">
              <div className="w-full relative">
                ...
                <img
                  src='/assets/homeContacts/drop.svg'
                  className="absolute right-2 bottom-3 w-4 h-4 pointer-events-none"
                  alt="dropdown arrow"
                />
              </div>
              <div className="w-full relative">
                ...
                <img
                  src='/assets/homeContacts/drop.svg'
                  className="absolute right-2 bottom-3 w-6 h-6 pointer-events-none"
                  alt="dropdown arrow"
                />
              </div>
            </div>
