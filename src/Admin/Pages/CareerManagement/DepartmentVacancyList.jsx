  ...
  return (
    <div>
      ...
      <div className='flex items-center justify-between border-b border-[#C1DBD8] pb-6'>
        ...
        <div className='text-[16px] font-semibold text-[#FFFFFF] bg-[#04A391] hover:bg-[#097468] duration-300 w-fit h-fit px-[32px] py-[10px] rounded-lg cursor-pointer' onClick={() => handleCreateClick(id)}>
          Create
        </div>
      </div>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-[57%] flex justify-center items-center">
          <div className="bg-white shadow-lg w-fit rounded-lg p-8">
            ...
            <div className='flex gap-2 mt-10 w-fit mx-auto'>
              ...
              <div className='text-[16px] font-medium text-[#FFFFFF] px-[32px] py-[10px] bg-[#ED1C24] hover:bg-[#AF2228] duration-300  rounded-lg cursor-pointer' onClick={confirmDelete}>Delete</div>
            </div>
