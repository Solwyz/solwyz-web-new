...
function SidebarItem({ label, icon, iconHover, activeItem, setActiveItem, to }) {
    ...
    return (
        <div className='text-black bg-[#FFFFFF] shadow-lg w-[283px] h-screen max-h-full fixed text-[24px] py-8'>
            ...
            <div className='mt-[80px] px-6 h-full'>
                ...
                <SidebarItem label="Logout" to="/login" icon={Logout} iconHover={LogoutHover} activeItem={activeItem} setActiveItem={setActiveItem} />
            </div>
        </div>
    );
}
