...
import EndToEnd from "../../Components/EndToEndService";
        ...
        <div className="md:w-[894px] ">
          <Link to="Web-Development">
            <div className="border group duration-300 md:justify-between hover:rounded-2xl hover:bg-gradient-to-b from-[#202020] to-[#0C0C0C] md:flex text-white border-[#2E2E2E] w-full md:py-8 pr-4 pl-4 pt-8 pb-4 md:pl-8 md:pr-[18px]">
              ...
              <p className="text-justify text-[#A5A5A5] font-medium md:w-[598px] justify-center mt-8 md:mt-5 group-hover:text-white text-sm leading-[18px]">
                We build responsive, high-performance websites tailored to your
                business needs. Whether e-commerce, corporate, or portfolio, our
                websites are fast, secure, and SEO-friendly. With intuitive
                UX/UI, mobile optimization, and scalable architecture, our web
                development ensures you make the right digital first impression
          ...
          <Link to="App-Development">
            <div className="border group duration-300 md:justify-between mt-3 hover:rounded-2xl hover:bg-gradient-to-b from-[#202020] to-[#0C0C0C] md:flex text-white border-[#2E2E2E] w-full md:py-8 pr-4 pl-4 pt-8 pb-4 md:pl-8 md:pr-[18px]">
              ...
              <p className="text-justify text-[#A5A5A5] font-medium md:w-[598px] justify-center mt-8 md:mt-5 group-hover:text-white text-sm leading-[18px]">
                Launch powerful mobile experiences across iOS and Android. Our
                app development service covers design, coding, and deployment of
                intuitive, scalable applications. From startups to enterprises,
                we create feature-rich apps that improve user experience, boost
                engagement, and align with your business model to meet evolving
          ...
          <Link to="ERP-Solution">
            <div className="border group duration-300 md:justify-between mt-3 hover:rounded-2xl hover:bg-gradient-to-b from-[#202020] to-[#0C0C0C] md:flex text-white border-[#2E2E2E] w-full md:py-8 pr-4 pl-4 pt-8 pb-4 md:pl-8 md:pr-[18px]">
              ...
              <p className="text-justify text-[#A5A5A5] font-medium md:w-[598px] justify-center mt-8 md:mt-5 group-hover:text-white text-sm leading-[18px]">
                Streamline business processes with customized ERP solutions. We
                integrate modules for finance, inventory, sales, and operations
                into one cohesive system. Our ERP software enhances
                productivity, data accuracy, and decision-making with real-time
                insights—ideal for growing businesses looking for control,
                efficiency, and scalability in a fast-moving environment.
              </p>
            </div>
          </Link>
          <Link to="CRM-Solution">
            <div className="border group duration-300 md:justify-between mt-3 hover:rounded-2xl hover:bg-gradient-to-b from-[#202020] to-[#0C0C0C] md:flex text-white border-[#2E2E2E] w-full md:py-8 pr-4 pl-4 pt-8 pb-4 md:pl-8 md:pr-[18px]">
              ...
              <p className="text-justify text-[#A5A5A5] font-medium md:w-[598px] justify-center mt-8 md:mt-5 group-hover:text-white text-sm leading-[18px]">
                Nurture leads and manage customer relationships effectively. Our
                CRM solutions offer smart tools for sales tracking, marketing
                automation, and client communication. Designed for ease of use
                and customization, our systems help businesses improve customer
                satisfaction, streamline operations, and drive long-term loyalty
