        ...
        <div className="md:flex md:justify-between">
          <div>
            ...
            <div className="text-[32px] font-bold mt-[21px]">
              Why you Should Join Our <br className="hidden md:block" />
              Awesome Team
            </div>

            <div className="mt-8">
              At Solwyz Technologies, we provide a friendly and{" "}
              <br className="hidden md:block" /> supportive workspace that helps
              you grow and thrive. Our <br className="hidden md:block" />{" "}
              positive and efficient work environment nurtures the right{" "}
              <br className="hidden md:block" /> talent, allowing you to reach
              your full potential.
            </div>
          </div>
