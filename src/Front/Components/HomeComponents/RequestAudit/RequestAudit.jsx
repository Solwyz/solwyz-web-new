            ...
            <form className=" md:mt-[64px] mt-[56px]">
              ...
              <div className="mt-6 md:mt-8">
                ...
                <div className="flex flex-col mt-5 gap-4 font-medium text-[#494949] text-sm">
                  {[
                    ...
                    <label key={goal} className="flex items-center gap-4">
                      <input
                        type="checkbox"
              ...
              <div className="mt-[56px] md:mt-[104px]">
                <button
                  ...
                  className="relative group w-full text-white py-3 rounded-md text-base font-medium bg-[#04A391] transition-all duration-400"
                >
