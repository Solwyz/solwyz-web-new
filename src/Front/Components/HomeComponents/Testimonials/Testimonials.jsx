...
const testimonials = [
  ...
  {
    name: "Sachin Mohan",
    company: "Managing Director - Hudson Papers ",
    text: "From concept to launch, Solwyz was responsive and creative. The website perfectly reflects our business values and product range",
    image: profImg,
  },
  {
    name: " Shajan Joseph",
  ...
  {
    name: "  Ruthin Losh",
    company: " Creative Director - De Arte Interiors",
    text: "Our website now mirrors our design philosophy, thanks to Solwyz. Their eye for detail and minimal layout was exactly what we needed.",
    image: profImg,
  },
  {
    name: " Anupriya Biju",
    company: " Principal Architect - Map Foundation ",
